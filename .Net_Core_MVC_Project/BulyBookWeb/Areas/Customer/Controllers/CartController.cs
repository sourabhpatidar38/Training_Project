...
namespace BulyBookWeb.Areas.Customer.Controllers
{
    [Area("Customer")]
    [Authorize]
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPost()
        {
            ...
            ShoppingCartVM.ListCart = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == claim.Value, includeProperties: "Product").ToList();
            ...
            {
                //Stripe settings
                var domain = "http://localhost:26887/";
                ...
                foreach (var item in ShoppingCartVM.ListCart)
                {
                    ...
                    var seseeionLineItem = new SessionLineItemOptions
                    {
                    ...
                    options.LineItems.Add(seseeionLineItem);
                }
